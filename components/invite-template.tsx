...
export const InviteTemplate: FC<InviteTemplateProps> = ({ className, template, formData }) => {
    ...
    return (
        ...
        >
            ...
            <div className="relative z-10">
                {/* Title */}
                <div className="text-3xl font-semibold text-center mb-3">{derivedFormData.title}</div>
                ...
                <div className="w-full flex justify-center text-2xl">
                    {template.tags?.includes("timer") &&
                        (formData?.date && formData?.time ? (
                            ...
                            <div className="text-red-500 text-lg">Select Date and Time to see timer!</div>
                        ))}
                </div>
