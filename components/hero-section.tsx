    ...
    <div className="w-full py-8 md:py-8 lg:py-12 xl:py-16 relative overflow-hidden flex flex-col justify-center">
      <div className="container px-4 md:px-6 md:ml-6 relative z-10">
        <div className="grid gap-6 lg:grid-cols-[1fr_400px] lg:gap-12 xl:grid-cols-[1fr_600px]">
          <div className="flex flex-col justify-center space-y-4">
            ...
            >
              <Link href="/signup">
                <Button
                  variant="default"
                  className="bg-blue-500 hover:bg-blue-700 text-white text-lg px-4 py-2 rounded flex items-center"
                >
              ...
              <Link href="/templates">
                <Button
                  variant="outline"
                  className="border border-blue-500 text-blue-500 hover:bg-blue-50 dark:hover:bg-blue-900 dark:text-blue-300 dark:border-blue-700 text-lg px-4 py-2 rounded"
                >
          ...
          >
            <div className=" relative h-[450px] w-full overflow-hidden rounded-xl  bg-background p-2">
