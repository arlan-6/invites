							...
							<TableRow key={invite.id} className="group">
								...
								<TableCell>
									<Tooltip >
										...
										<TooltipContent className={cn(invite.template?.color, "text-accent-foreground font-semibold p-2 px-3 rounded-sm")}>
											{/* Tooltip provides more context */}
											<p className={cn( "bg-accent p-2 px-3 rounded-xs ")}>
								...
								<TableCell className="text-center">
									<Tooltip>
										...
										<TooltipContent>
											{/* Tooltip provides more context */}
											<p>
												Expiration Date: {invite.expiresAt.toLocaleString()}
											</p>
										</TooltipContent>
									</Tooltip>
								</TableCell>
