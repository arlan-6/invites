export const translations = {
	en: {
		...
		"templates.clearFilters":"Cleat filter",
		"templates.loadingTemplates":'Loading templates...',
		'templates.errorLoadingTemplates':"Error loading templates: ",
		"templates.noTemplatesFound":'No templates found matching "{search}".',
		'templates.noTemplatesAvailable':"No templates available.",
		'templates.cardInivteTempltes':"Card inivte templates",
		'templates.templateCardNoName':'No Name',
		'templates.templateCardNoDescription':'No Description',
		...
		"inviteEditor.goToDashboard": "Go to dashboard ",
		"inviteEditor.title": "Title",
		"inviteEditor.eventTitle": "Event title",
		"inviteEditor.eventTitle-placeholder": "Birthday party",
		"inviteEditor.eventDate": "Event date",
		"inviteEditor.eventDate-placeholder": "2022-12-31 ",
		"inviteEditor.eventTime": "Event time",
		"inviteEditor.eventTime-placeholder": "12:00 PM | 18:00",
		"inviteEditor.eventLocation": "Event location",
		"inviteEditor.eventLocation-placeholder": "Almaty, Abai 123",
		...
		"inviteEditor.eventMessage-placeholder":
			"Join us for a night of fun and celebration!",
		"invitePreview.youAreInvited": "You are invited!",
		"invitePreview.timerStarts": "Event starts in:",
		"invitePreview.timerPlaceholder": "Select Date & Time for timer",
		...
		"advanced-template-editor.emptyState.message":
			"Template not loaded or has no fields.",
		...
		"advanced-template-editor.placeholder.address":
			"E.g., 123 Main St, Anytown",
		"advanced-template-editor.label.addressLink": "Address Map Link",
		"advanced-template-editor.placeholder.addressLink":
			"E.g., https://maps.app.goo.gl/...",
		"advanced-template-editor.label.contactInfo": "Contact Information",
		"advanced-template-editor.placeholder.contactInfo":
			"E.g., Jane Doe (555-1234)",
		"advanced-template-editor.label.message": "Invitation Message",
		"advanced-template-editor.placeholder.message":
			"E.g., Join us for a celebration!",
		...
		"advanced-template-editor.placeholder.themeOrMessage":
		...
		"advanced-template-editor.placeholder.giftInfo":
			"E.g., Registry link or 'No gifts please'",
	...
	kk: {
		...
		"templates.searchTemplates": "Шаблондарды іздеу",
		"templates.clearFilters": "Сүзгілерді тазалау",
		"templates.loadingTemplates": "Шаблондар жүктелуде...",
		"templates.errorLoadingTemplates": "Шаблондарды жүктеуде қате: ",
		"templates.noTemplatesFound": '"{search}" бойынша сәйкес келетін шаблон дар табылмады.',
		"templates.noTemplatesAvailable": "Қол жетімді шаблон дар жоқ.",
		"templates.cardInivteTempltes": "Карточкамен шақыру шаблон дары",
		"templates.templateCardNoName": "Атысыз",
  "templates.templateCardNoDescription": "Сипаттамасыз",
		"inviteEditor.clear": "Тазалау",
		"inviteEditor.share": "Бөлісу",
		"inviteEditor.needSignUp": "Алдымен тіркелу қажет!",
		"inviteEditor.dialogCloseText":
			"Диалог терезесін жапқаннан кейін сіз бақылау тақтасына қайта бағытталасыз",
		"inviteEditor.dialogLinkText": "Шақыру сілтемесі",
		"inviteEditor.goToDashboard": "Бақылау тақтасына өту",

		"inviteEditor.title": "Атауы",
		"inviteEditor.eventTitle": "Іс-шара атауы",
		"inviteEditor.eventTitle-placeholder": "Туған күн кеші",
		"inviteEditor.eventDate": "Іс-шара күні",
		"inviteEditor.eventDate-placeholder": "2022-12-31",
		"inviteEditor.eventTime": "Іс-шара уақыты",
		"inviteEditor.eventTime-placeholder": "12:00 | 18:00",
		"inviteEditor.eventLocation": "Іс-шара орны",
		"inviteEditor.eventLocation-placeholder": "Алматы, Абай 123",
		...
		"inviteEditor.eventMessage-placeholder": "Көңілді кешке қосылыңыз!",
		"invitePreview.youAreInvited": "Сіз шақырылдыңыз!",
		"invitePreview.timerStarts": "Іс-шараның басталуына дейін:",
		"invitePreview.timerPlaceholder": "Таймер үшін күн мен уақытты таңдаңыз",
		...
		"advanced-template-editor.emptyState.message":
			"Үлгі жүктелмеген немесе өрістері жоқ.",
		...
		"advanced-template-editor.label.themeOrMessage":
			"Тақырыбы немесе қысқа хабарлама",
		"advanced-template-editor.placeholder.themeOrMessage":
			"Мыс., Тропикалық жұмақ",
		...
		"advanced-template-editor.placeholder.giftInfo":
			"Мыс., Тізімге сілтеме немесе 'Сыйлық қажет емес'",
	...
	ru: {
		...
		"templates.searchTemplates": "Поиск шаблонов",
  "templates.clearFilters": "Очистить фильтры",
  "templates.loadingTemplates": "Загрузка шаблонов...",
  "templates.errorLoadingTemplates": "Ошибка загрузки шаблонов: ",
  "templates.noTemplatesFound": 'Шаблоны, соответствующие "{search}", не найдены.',
  "templates.noTemplatesAvailable": "Нет доступных шаблонов.",
  "templates.cardInivteTempltes": "Шаблоны приглашений на карточках",
  "templates.templateCardNoName": "Нет названия",
  "templates.templateCardNoDescription": "Нет описания",
		"inviteEditor.clear": "Очистить",
		"inviteEditor.share": "Поделиться",
		"inviteEditor.needSignUp": "Сначала нужно войти!",
		"inviteEditor.dialogCloseText":
			"После закрытия диалога вы будете перенаправлены на панель управления",
		"inviteEditor.dialogLinkText": "Ссылка на приглашение",
		"inviteEditor.goToDashboard": "Перейти на панель управления",

		"inviteEditor.title": "Название",
		"inviteEditor.eventTitle": "Название события",
		"inviteEditor.eventTitle-placeholder": "День рождения",
		"inviteEditor.eventDate": "Дата события",
		"inviteEditor.eventDate-placeholder": "2022-12-31",
		"inviteEditor.eventTime": "Время события",
		"inviteEditor.eventTime-placeholder": "12:00 | 18:00",
		"inviteEditor.eventLocation": "Место события",
		"inviteEditor.eventLocation-placeholder": "Алматы, Абая 123",
		...
		"invitePreview.youAreInvited": "Вы приглашены!",
		"invitePreview.timerStarts": "Начало события через:",
		"invitePreview.timerPlaceholder": "Выберите дату и время для таймера",
		...
		"advanced-template-editor.emptyState.message":
			"Шаблон не загружен или не содержит полей.",
		...
		"advanced-template-editor.label.themeOrMessage":
			"Тема или краткое сообщение",
		"advanced-template-editor.placeholder.themeOrMessage":
			"Напр., Тропический рай",
		"advanced-template-editor.label.dressCode": "Дресс-код",
		"advanced-template-editor.placeholder.dressCode":
			"Напр., Повседневный, Вечерний",
		"advanced-template-editor.label.giftInfo": "Информация о подарках",
		"advanced-template-editor.placeholder.giftInfo":
			"Напр., Ссылка на реестр или 'Подарки не нужны'",
